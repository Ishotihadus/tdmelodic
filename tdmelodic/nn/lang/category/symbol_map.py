...
from .list_of_symbols.acc_concat import accent_map
from .list_of_symbols.goshu import goshu_map
from .list_of_symbols.pos_short import pos_map
...
numeric_to_char_symbol = {
    i + 1: c
    for i, c in enumerate(string.digits + string.ascii_letters + string.punctuation)
}
